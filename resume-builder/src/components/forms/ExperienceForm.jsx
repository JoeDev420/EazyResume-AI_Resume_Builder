      ...
      <form className="form-animate flex flex-col gap-6 bg-white p-6 w-full min-w-md max-w-5xl px-2 mx-auto">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between items-center">
            ...
            <button
              type="button"
              className="w-34 h-10 relative flex items-center gap-2 text-purple-600 border border-purple-200 px-4 rounded-full text-sm hover:bg-purple-50 transition wrap-break-word"
              onClick={
                user.premium
